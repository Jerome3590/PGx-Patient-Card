...
PGx_df_step1 <- left_join(pgx_data_long, CPIC_df, by=c("Gene" = "Gene"))

PGx_df_step2 <- left_join(PGx_df_step1, pharm_GKB_df, by=c("Gene" = "data.symbol"))

PGx_df_step3 <- left_join(PGx_df_step2, FDA_df, by=c("Gene" = "Gene"))
